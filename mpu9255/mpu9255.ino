...
unsigned long poprzedniCzas = millis();
double aktualnaWysokosc = 0;
double poprzedniaWysokosc = 0;
float vario = 0;
...
void loop()
{
  while (1)
  {
    ...
    */
    ...
    //zrobic warunek na wysokosc zero(start systemu)
    poprzedniCzas = aktualnyCzas;
    poprzedniaWysokosc = aktualnaWysokosc;
    aktualnyCzas = millis();
    aktualnaWysokosc = bmp.readAltitude(1019.0);
    vario = (aktualnaWysokosc-poprzedniaWysokosc)/((aktualnyCzas-poprzedniCzas)/100);
    //Serial.print("   |");
    //Serial.print(aktualnaWysokosc-poprzedniaWysokosc);
    //Serial.print("   |");
    //Serial.print((aktualnyCzas-poprzedniCzas));
    //Serial.print("   |");
    Serial.print(vario);
